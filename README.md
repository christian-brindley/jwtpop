...
If the device key is already registered to the user's identity, then authentication is complete and the user is given access. If the device key is not known, then the user can be authenticated using as many available factors as required, after which the device key is registered for subsequent logins, as per [this sample flow](https://sequencediagram.org/index.html#initialData=).
